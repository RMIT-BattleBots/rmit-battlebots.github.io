    ...
    <main className="min-h-screen bg-black">
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-20 md:py-32">
        ...
        <div className="mb-16 border-b border-cyan-500/20 pb-16">
          <h2 className="text-sm font-light tracking-wider text-cyan-400 uppercase mb-8">
            Get in Touch
          </h2>
          ...
          <div className="space-y-8 mb-12">
            <div>
              ...
              <p className="text-gray-400 font-light">RMIT City Campus</p>
        ...
        <div className="border-b border-cyan-500/20 pb-16">
          ...
          <div>
            <h3 className="text-lg font-light text-white mb-4">Membership</h3>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block border border-cyan-400/50 text-cyan-400 px-6 py-3 text-sm font-light tracking-wide hover:bg-cyan-400/10 hover:border-cyan-400 hover:glow-cyan-sm transition-all"
            >
              Join Now
            </a>
          </div>
